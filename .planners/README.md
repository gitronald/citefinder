...
|---|---|---|---|---|
| 010 | [Derive the verify cache directory from the source directory, not the bib stem](plans/010-verify-cache-dir-collisions/plan.md) | active | — | [#48](https://github.com/gitronald/citefinder/pull/48) |
